class RemovePopulationsInfectedDays < ActiveRecord::Migration[5.2]
  def up
    change_table :simulation_contagion_populations do |t|
      ...
      t.index %i[instant_id group_id days], name: :simulation_contagion_unique_keys, unique: true
  ...
  def down
    change_table :simulation_contagion_populations do |t|
      ...
      t.index %i[instant_id group_id infected_days], name: :simulation_contagion_unique, unique: true
